...
# --- 2. ฟังก์ชันสร้างคำแนะนำ (Coach's Logic) ---
def get_coach_advice(runner_type, cs_pace, dp):
    """สร้างข้อความคำแนะนำตามประเภทนักวิ่ง"""
...
def create_pdf(student_name, test_date, cs, dp, runner_type, zones_df, advice_text):
    ...
    w_cols = [35, 25, 45, 85] # ปรับความกว้างคอลัมน์
...
if calculate_btn:
    try:
        ...
        col3.metric("Type", runner_type.split()[0]) # Show just Diesel/Turbo/Hybrid

        st.markdown("---")
        
        # Display Advice on Screen
        st.info(advice_text) # แสดงคำแนะนำในกล่องสีฟ้าบนหน้าเว็บ
